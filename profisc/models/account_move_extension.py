...
class AccountMoveExtension(models.Model):
    ...
    profisc_fisc_status_sale = fields.Char(string='Cis Sale Status', default=None, copy=False)
    profisc_iic = fields.Char(string='IIC', copy=False)
    profisc_fic = fields.Char(string='FIC', copy=False)
    profisc_eic = fields.Char(string='EIC', default=None, copy=False)
    profisc_qr_code = fields.Char(string='Qr Url', copy=False)
    profisc_qr_code_check = fields.Binary(string='Qr Code', attachment=True, copy=False)
    ...
    profisc_fic_error_code = fields.Char(string='FIC Error Code', copy=False)
    ...
    profisc_eic_error_description = fields.Char(string='EIC Error Description', copy=False)
